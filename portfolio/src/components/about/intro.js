...
export default function Intro() {
    return (
      <div className="ml- mr-10 lg:ml-28 mr-28 p-10">
        ...
        <h1><br/></h1>
        <p className="text-xl lg:text-2xl mt-5 text-white">I build accessible, inclusive products and digital experiences for the Web/Apps.<br/>I'm also passoionate about Open Source, Linux and Machine Learning!</p>
